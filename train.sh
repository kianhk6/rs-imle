...
# Example 1: Auto mode (default) - chooses based on condition_path
# If condition_path is set -> UNet, otherwise -> VDVAE
# python train.py --hps fewshot --model_type auto --data_root ./datasets/ffhq/
...
# VDVAE → 20-steps 
nohup bash -c "CUDA_VISIBLE_DEVICES=0 python train.py --hps fewshot \
   --save_dir /home/kha98/Desktop/rs-imle/one-schedule/VDVAE-20-steps \
   --data_root /home/kha98/Desktop/rs-imle/dataset/ffhq/20_steps_seed_9 \
