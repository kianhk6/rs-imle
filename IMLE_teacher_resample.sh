...
echo "During resampling: 100 NEW samples will be generated from teacher"
...
CUDA_VISIBLE_DEVICES=0 /home/kha98/Desktop/.venv/bin/python /home/kha98/Desktop/rs-imle/train.py \
    ...
    --every_n_epochs_resample_data "800,200,100,50" \
    --change_schedule_of_data_resampling_every_n_epoch "800,2000,6000" \
